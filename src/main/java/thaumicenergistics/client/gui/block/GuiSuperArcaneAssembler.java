...
import thaumicenergistics.container.block.ContainerSuperArcaneAssembler;
import thaumicenergistics.init.ModGlobals;
import thaumicenergistics.network.PacketHandler;
import thaumicenergistics.network.packets.PacketSubscribe;
import thaumicenergistics.network.packets.PacketSuperAssemblerGUIUpdateRequest;
...
import java.util.HashMap;
     ...
     * @author MilkiBlack
     */
    public class GuiSuperArcaneAssembler extends GuiBase {
        ...
        private static final ResourceLocation BACKGROUND_INACTIVE = new ResourceLocation(ModGlobals.MOD_ID, "textures/gui/super_arcane_assembler/inactive.png");
        private static final ResourceLocation BACKGROUND_ACTIVE = new ResourceLocation(ModGlobals.MOD_ID, "textures/gui/super_arcane_assembler/active.png");
        private static final ResourceLocation ASPECTS = new ResourceLocation(ModGlobals.MOD_ID, "textures/gui/super_arcane_assembler/aspects.png");
        private static final int WIDTH = 210;
        private static final int HEIGHT = 231;
        private final ContainerSuperArcaneAssembler container;
        private final IItemHandler inv;
        private float enAlpha;
        private boolean hasEnoughVis = true;
        private HashMap<String, Boolean> aspectExists = new HashMap<>();

        public GuiSuperArcaneAssembler(ContainerSuperArcaneAssembler container){
            super(container);
        ...
        @Override
        public void initGui() {
            PacketHandler.sendToServer(new PacketSuperAssemblerGUIUpdateRequest(this.container.getTE()));
            this.xSize = WIDTH;
            this.ySize = HEIGHT;
            super.initGui();
        }
