...
public class GuiHandler implements IGuiHandler {
    ...
    public Object getServerGuiElement(int ordinal, EntityPlayer player, World world, int x, int y, int z) {
        ...
        switch (guiID) {
            ...
            case SUPER_ARCANE_ASSEMBLER:
                return new ContainerSuperArcaneAssembler(player,(TileSuperArcaneAssembler) te);
    ...
    public Object getClientGuiElement(int ordinal, EntityPlayer player, World world, int x, int y, int z) {
        ...
        switch (guiID) {
            ...
            case SUPER_ARCANE_ASSEMBLER:
                return new GuiSuperArcaneAssembler(new ContainerSuperArcaneAssembler(player,(TileSuperArcaneAssembler) te));
            case ESSENTIA_IMPORT_BUS:
