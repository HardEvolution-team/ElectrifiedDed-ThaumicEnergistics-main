...
public class ArcaneAssemblerAdvRenderer extends TileEntitySpecialRenderer<TileArcaneAssemblerAdv> {
    private final double particleMultiplier = ThEApi.instance().config().arcaneAssemblerAdvParticleMultiplier();
    private double particleProgress = 0.0F;

    @Override
    public void render(TileArcaneAssemblerAdv te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
