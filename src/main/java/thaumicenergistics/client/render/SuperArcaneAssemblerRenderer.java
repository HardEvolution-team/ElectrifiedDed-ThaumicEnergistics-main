...
/**
    ...
    public class SuperArcaneAssemblerRenderer extends TileEntitySpecialRenderer<TileSuperArcaneAssembler> {
        private final double particleMultiplier = ThEApi.instance().config().superarcaneAssemblerParticleMultiplier();
        private double particleProgress = 0.0F;

        @Override
        public void render(TileSuperArcaneAssembler te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
