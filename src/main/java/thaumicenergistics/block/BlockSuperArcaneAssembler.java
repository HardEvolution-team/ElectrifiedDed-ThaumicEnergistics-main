...
import java.util.Objects;
     ...
     * @author MilkiBlack
     */
    public class BlockSuperArcaneAssembler extends BlockNetwork implements IThEModel {

        public BlockSuperArcaneAssembler(String id) {
            super(id);
        ...
        public void registerTileEntity() {
            ...
            GameRegistry.registerTileEntity(TileSuperArcaneAssembler.class, Objects.requireNonNull(getRegistryName()));
        }
        ...
        public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
            ...
            if (te instanceof TileSuperArcaneAssembler) {
                TileSuperArcaneAssembler arcAssembTE = (TileSuperArcaneAssembler) te;
        ...
        public TileEntity createNewTileEntity(World worldIn, int meta) {
            return new TileSuperArcaneAssembler();
        }
