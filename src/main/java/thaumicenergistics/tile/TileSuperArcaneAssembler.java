        ...
        protected float getWorldVis() {
            return ThEApi.instance().items().upgradeArcane().maybeStack(1).map(visRangeUpgrade -> {
                ...
                if(this.upgradeInv.getUpgrades(visRangeUpgrade) > 0){
                    vis += AuraHelper.getVis(this.getWorld(), this.getPos().add(-20, 0, -20));
                    vis += AuraHelper.getVis(this.getWorld(), this.getPos().add(-20, 0, 0));
                    vis += AuraHelper.getVis(this.getWorld(), this.getPos().add(-20, 0, 20));

                    vis += AuraHelper.getVis(this.getWorld(), this.getPos().add(0, 0, -20));
                    vis += AuraHelper.getVis(this.getWorld(), this.getPos().add(0, 0, 20));
